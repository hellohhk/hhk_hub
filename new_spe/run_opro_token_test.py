...
def parse_args():
    p = argparse.ArgumentParser(description="OPRO Standalone Test (Run Best Prompt on Test Set)")
...
def main():
    ...
    args = parse_args()
    print("\n" + "=" * 60)
    print("🎯 OPRO 独立测试模式: 验证进化出的最佳提示词")
    print("=" * 60 + "\n")

    # 2. 🌟 直接硬编码注入 OPRO 进化出的最佳提示词
    best_prompt_text = "Answer the question directly and concisely."
    ...
    result_file = "opro_test_result.json"
